...
import ProductList from "../PopularProduct/Products";
...
function SalesItems() {
  ...
  return (
    <>
      <section className="PopularProduct mt-10 h-full lg:h-[371px] xl:h-[384px] flex flex-col lg:flex-row px-5 lg:px-12 gap-6 ">
        <img
          src="asset 13.jpeg"
          alt=""
